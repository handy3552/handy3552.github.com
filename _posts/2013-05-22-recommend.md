...
+ [使用 JCaptcha 开发图形和声音验证码](http://www.ibm.com/developerworks/cn/opensource/os-cn-jcaptcha/index.html)
+ [Node.js 究竟是什么？](http://www.ibm.com/developerworks/cn/opensource/os-nodejs/index.html)
+ [淘宝IP地址库](http://ip.taobao.com/instructions.php)
+ [jquery-mobile](http://jquerymobile.com/)
+ [基于Dropbox的blog系统 Scriptogr.am](http://scriptogr.am)